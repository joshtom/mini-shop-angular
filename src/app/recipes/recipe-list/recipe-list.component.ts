...
export class RecipeListComponent implements OnInit {
  ...
  recipes: Recipe[] = [
    new Recipe('Salad', 'Sweet salad', 'https://www.gimmesomeoven.com/wp-content/uploads/2014/03/Cajun-Jambalaya-Recipe-with-Andouille-Sausage-Shrimp-and-Chicken-3-1.jpg'),
